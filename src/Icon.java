...
public class Icon {
    ...
    public static void drawHouses() {
        drawHouse(20, 20, 15, 20, Color.red);
        drawHouse(50, 20, 20, 30, Color.blue);
        drawHouse(80, 20, 15, 25, Color.green);
    }

    public static void drawHouse(double x, double y, double width, double height, Color color) {
        StdDraw.setPenColor(color);
        StdDraw.filledRectangle(x, y, width / 2, height / 2);
        StdDraw.setPenColor(Color.white);
        StdDraw.filledRectangle(x, y + height / 2 + 5, width / 2, 5); // Window
        StdDraw.setPenColor(new Color(139, 69, 19)); // Brown
        StdDraw.filledRectangle(x, y + height / 2 + 5, 2, 2); // Door
    }
